...
$index[1] = "DE";
              ...
              $index[5] = "US";
for($i=0;$i<6;$i++){
    echo "<a role=\"button\" class=\"btn btn-default\" href=\"list.php\">".${'countries'}[$index[$i]]."</a>";
}
              ?>
...
//          $index2=[22,54,7,19,46,6,60,58,75,77,27,2,24,13,101,102];
//for($j=0;$j<16;$j++) {
//echo"
//            <li>
//                 <a href = \"detail.php?id=22\" class=\"img-responsive\" >
//                 	<img src = \"images/square/".${'images'}[$index2[$j]]['path']."\" alt = \"View of Cologne\" >
//                 	<div class=\"caption\" >
//                 		<div class=\"blur\" >
//                 		</div >
//                 		<div class=\"caption-text\" >
//                 			<h1 >".${'images'}[$index2[$j]]['title']."</h1 >
//                 		</div >
//                 	</div >
//                 </a >
//			 </li >//第一种方法
...
//			 }
          for($j=0;$j<105;$j++){
              if(isset(${'images'}[$j])&&$j==${'images'}[$j]['id']){
                  echo"
            <li>
                 <a href = \"detail.php?id=22\" class=\"img-responsive\" >
                 	<img src = \"images/square/".${'images'}[$j]['path']."\" alt = \"View of Cologne\" >
                 	<div class=\"caption\" >
                 		<div class=\"blur\" >
                 		</div >
                 		<div class=\"caption-text\" >
                 			<h1 >".${'images'}[$j]['title']."</h1 >
                 		</div >
                 	</div >
                 </a >
			 </li >";
